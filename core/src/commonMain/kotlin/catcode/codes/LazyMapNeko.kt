...
// protected constructor(private val params: LazyMap<String, String>, override var type: String) :
//     Neko,
//     Map<String, String> by params {
//     public constructor(type: String) : this(LazyMap(emptyMap()), type)
//     public constructor(type: String, params: Map<String, String>) : this(params.toLazyMap(), type)
//     public constructor(type: String, vararg params: CatKV<String, String>) : this(mapOf(*params.toPair()).toLazyMap(), type)
//     public constructor(type: String, vararg params: String) : this(mapOf(*params.map {
...
//      * 获取转义后的字符串
//      */
//     override fun getWithoutDecode(key: String): String? = CatEncoder.encodeParamsOrNull(this[key])
//
//     /**
...
//         @JvmStatic
//         @JvmOverloads
//         public fun byCode(code: String, decode: Boolean = true): LazyMapNeko {
...
// private constructor(private val params: MutableLazyMap<String, String>, type: String) :
//     LazyMapNeko(params.asLazyMap(), type),
//     MutableNeko,
...
//      * 转化为参数可变的[MutableNeko]
//      */
//     override fun mutable(): MutableNeko = LazyMutableMapNeko(params, type)
//
//
//     /**
//      * 转化为不可变类型[Neko]
